...
class LocalsControllerTest < ActionController::TestCase
  ...
  test "should create local" do
    assert_difference('Local.count') do
      post :create, local: { direccion: @local.direccion, nombre: @local.nombre, telefono: @local.telefono, ubigeo_id: @local.ubigeo_id }
    end
  ...
  test "should update local" do
    patch :update, id: @local, local: { direccion: @local.direccion, nombre: @local.nombre, telefono: @local.telefono, ubigeo_id: @local.ubigeo_id }
    assert_redirected_to local_path(assigns(:local))
  end
