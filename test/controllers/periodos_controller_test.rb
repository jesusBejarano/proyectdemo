...
class PeriodosControllerTest < ActionController::TestCase
  ...
  test "should create periodo" do
    assert_difference('Periodo.count') do
      post :create, periodo: { FechaFinal: @periodo.FechaFinal, FechaInicial: @periodo.FechaInicial, nombre: @periodo.nombre }
    end
  ...
  test "should update periodo" do
    patch :update, id: @periodo, periodo: { FechaFinal: @periodo.FechaFinal, FechaInicial: @periodo.FechaInicial, nombre: @periodo.nombre }
    assert_redirected_to periodo_path(assigns(:periodo))
  end
