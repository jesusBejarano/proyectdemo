...
class DetallePedidosControllerTest < ActionController::TestCase
  ...
  test "should create detalle_pedido" do
    assert_difference('DetallePedido.count') do
      post :create, detalle_pedido: { NombreProducto: @detalle_pedido.NombreProducto, PrecioParcial: @detalle_pedido.PrecioParcial, cantidad: @detalle_pedido.cantidad, pedido_id: @detalle_pedido.pedido_id }
    end
  ...
  test "should update detalle_pedido" do
    patch :update, id: @detalle_pedido, detalle_pedido: { NombreProducto: @detalle_pedido.NombreProducto, PrecioParcial: @detalle_pedido.PrecioParcial, cantidad: @detalle_pedido.cantidad, pedido_id: @detalle_pedido.pedido_id }
    assert_redirected_to detalle_pedido_path(assigns(:detalle_pedido))
  end
